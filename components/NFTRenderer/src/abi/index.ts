export const RMRKEquipRenderUtilsABI = [
  { inputs: [], name: "RMRKChildNotFoundInParent", type: "error" },
  { inputs: [], name: "RMRKMismachedArrayLength", type: "error" },
  { inputs: [], name: "RMRKNotComposableAsset", type: "error" },
  { inputs: [], name: "RMRKParentIsNotNFT", type: "error" },
  { inputs: [], name: "RMRKTokenHasNoAssets", type: "error" },
  { inputs: [], name: "RMRKUnexpectedParent", type: "error" },
  {
    inputs: [
      { internalType: "address", name: "childAddress", type: "address" },
      { internalType: "uint256", name: "childId", type: "uint256" },
      { internalType: "address", name: "expectedParent", type: "address" },
      { internalType: "uint256", name: "expectedParentId", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "equippableGroupId", type: "uint64" },
      { internalType: "address", name: "catalogAddress", type: "address" },
      {
        components: [
      ...
      },
      {
        components: [
          ...
          { internalType: "string", name: "partMetadata", type: "string" },
        ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "directOwner", type: "address" },
      { internalType: "uint256", name: "ownerId", type: "uint256" },
      { internalType: "bool", name: "isNFT", type: "bool" },
      { internalType: "bool", name: "inParentsActiveChildren", type: "bool" },
      { internalType: "bool", name: "inParentsPendingChildren", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "parentAssetId", type: "uint64" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "targetChild", type: "address" },
      { internalType: "uint256", name: "childId", type: "uint256" },
      { internalType: "bool", name: "onlyEquipped", type: "bool" },
    ],
    name: "getAllEquippableSlotsFromParent",
    outputs: [
      { internalType: "uint256", name: "childIndex", type: "uint256" },
      {
        components: [
          { internalType: "uint64", name: "slotPartId", type: "uint64" },
          { internalType: "uint64", name: "childAssetId", type: "uint64" },
          { internalType: "uint64", name: "parentAssetId", type: "uint64" },
          { internalType: "uint64", name: "priority", type: "uint64" },
          {
            internalType: "address",
            name: "parentCatalogAddress",
            type: "address",
          },
          { internalType: "bool", name: "isEquipped", type: "bool" },
          { internalType: "string", name: "partMetadata", type: "string" },
          {
            internalType: "string",
            name: "childAssetMetadata",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "target", type: "address" },
      { internalType: "uint256", name: "tokenId", type: "uint256" },
      { internalType: "uint64[]", name: "assetIds", type: "uint64[]" },
    ],
    name: "getAssetsById",
  ...
  },
  {
    ...
    name: "getEquipped",
    outputs: [
      { internalType: "uint64[]", name: "slotPartIds", type: "uint64[]" },
      {
        components: [
          { internalType: "uint64", name: "assetId", type: "uint64" },
          { internalType: "uint64", name: "childAssetId", type: "uint64" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "address", name: "catalogAddress", type: "address" },
          { internalType: "string", name: "metadata", type: "string" },
          { internalType: "uint64[]", name: "partIds", type: "uint64[]" },
        ],
        internalType:
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "tokenId", type: "uint256" },
      { internalType: "address", name: "targetCollection", type: "address" },
    ],
    name: "getExtendedNft",
    outputs: [
      {
        components: [
          { internalType: "string", name: "tokenMetadataUri", type: "string" },
          { internalType: "address", name: "directOwner", type: "address" },
          ...
          { internalType: "uint64[]", name: "priorities", type: "uint64[]" },
          ...
          { internalType: "bool", name: "hasNestingInterface", type: "bool" },
          {
            internalType: "bool",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "target", type: "address" },
      { internalType: "uint256", name: "pageStart", type: "uint256" },
      { internalType: "uint256", name: "pageSize", type: "uint256" },
    ],
    name: "getPaginatedMintedIds",
    outputs: [{ internalType: "uint256[]", name: "page", type: "uint256[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint64[]", name: "parentSlotPartIds", type: "uint64[]" },
      { internalType: "address", name: "catalogAddress", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "getTopAsset",
    outputs: [
      { internalType: "uint64", name: "topAssetId", type: "uint64" },
      { internalType: "uint64", name: "topAssetPriority", type: "uint64" },
      { internalType: "string", name: "topAssetMetadata", type: "string" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "parentAddress", type: "address" },
      { internalType: "uint256", name: "parentId", type: "uint256" },
      { internalType: "address", name: "parentAssetCatalog", type: "address" },
      { internalType: "address", name: "childAddress", type: "address" },
      { internalType: "uint256", name: "childId", type: "uint256" },
      { internalType: "uint64", name: "childAssetId", type: "uint64" },
      { internalType: "uint64", name: "slotPartId", type: "uint64" },
    ...
    outputs: [{ internalType: "bool", name: "isEquipped", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      { internalType: "bool", name: "isRejectedOrAbandoned", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "uint64[]", name: "allPartIds", type: "uint64[]" },
      { internalType: "address", name: "catalogAddress", type: "address" },
    ],
    name: "splitSlotAndFixedParts",
    outputs: [
      { internalType: "uint64[]", name: "slotPartIds", type: "uint64[]" },
      { internalType: "uint64[]", name: "fixedPartIds", type: "uint64[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "parentAddress", type: "address" },
      { internalType: "address[]", name: "childAddresses", type: "address[]" },
      { internalType: "uint256", name: "parentId", type: "uint256" },
      { internalType: "uint256[]", name: "childIds", type: "uint256[]" },
    ],
...
export const LightmValidatorLibABI = [
  {
    inputs: [
      {
        internalType: "address",
...
export const EmotableRegistryABI = [
  {
    type: "error",
