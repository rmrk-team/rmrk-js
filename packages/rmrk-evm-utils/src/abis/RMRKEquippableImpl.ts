export const RMRKEquippableImpl = [
  {
    inputs: [
      ...
      { internalType: 'uint16', name: 'royaltyPercentageBps', type: 'uint16' },
    ],
  ...
  { inputs: [], name: 'ERC721TransferFromIncorrectOwner', type: 'error' },
  ...
  { inputs: [], name: 'RMRKEquippableEquipNotAllowedByCatalog', type: 'error' },
  ...
  { inputs: [], name: 'RMRKMaxPendingAssetsReached', type: 'error' },
  ...
  { inputs: [], name: 'RMRKMintOverMax', type: 'error' },
  { inputs: [], name: 'RMRKMintToNonRMRKNestableImplementer', type: 'error' },
  { inputs: [], name: 'RMRKMintZero', type: 'error' },
  ...
  { inputs: [], name: 'RMRKNoAssetMatchingId', type: 'error' },
  { inputs: [], name: 'RMRKNotApprovedForAssetsOrOwner', type: 'error' },
  { inputs: [], name: 'RMRKNotApprovedOrDirectOwner', type: 'error' },
  { inputs: [], name: 'RMRKNotEquipped', type: 'error' },
  { inputs: [], name: 'RMRKNotOwner', type: 'error' },
  { inputs: [], name: 'RMRKNotOwnerOrContributor', type: 'error' },
  { inputs: [], name: 'RMRKPendingChildIndexOutOfRange', type: 'error' },
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'uint64', name: 'assetId', type: 'uint64' },
      { internalType: 'uint64', name: 'replacesAssetWithId', type: 'uint64' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'uint256', name: 'maxChildrenBurns', type: 'uint256' },
    ],
    name: 'burn',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'uint64', name: 'assetId', type: 'uint64' },
      { internalType: 'uint64', name: 'slotId', type: 'uint64' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: 'to', type: 'address' },
      { internalType: 'uint256', name: 'numToMint', type: 'uint256' },
      { internalType: 'uint256', name: 'destinationId', type: 'uint256' },
      { internalType: 'string', name: 'tokenURI', type: 'string' },
    ],
    name: 'nestMint',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'uint256', name: 'maxRejections', type: 'uint256' },
    ],
