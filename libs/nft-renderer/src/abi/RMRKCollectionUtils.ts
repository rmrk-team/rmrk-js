export const RMRKCollectionUtils = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bool', name: 'supports721', type: 'bool' },
      { internalType: 'bool', name: 'supportsMultiAsset', type: 'bool' },
      { internalType: 'bool', name: 'supportsNesting', type: 'bool' },
      { internalType: 'bool', name: 'supportsEquippable', type: 'bool' },
      { internalType: 'bool', name: 'supportsSoulbound', type: 'bool' },
      { internalType: 'bool', name: 'supportsRoyalties', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
